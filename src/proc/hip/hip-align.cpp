...
#define RS2_HIP_THREADS_PER_BLOCK 32

using namespace librealsense;
using namespace rship;
    ...
    const rs2_intrinsics* other_intrin, const rs2_extrinsics* depth_to_other, float depth_val, int depth_x, int depth_y, int block_index)
{
    ...
    rship::rs2_deproject_pixel_to_point(depth_point, depth_intrin, depth_pixel, depth_val);
    rship::rs2_transform_point_to_point(other_point, depth_to_other, depth_point);
    rship::rs2_project_point_to_pixel(other_pixel, other_intrin, other_point);
...
void align_hip_helper::align_other_to_depth(unsigned char* h_aligned_out, const uint16_t* h_depth_in,
    ...
    const rs2_intrinsics& h_other_intrin, const unsigned char* h_other_in, rs2_format other_format, int other_bytes_per_pixel)
{
    ...
    // allocate and copy objects to HIP device memory
    ...
    // config threads
    dim3 threads(RS2_HIP_THREADS_PER_BLOCK, RS2_HIP_THREADS_PER_BLOCK);
    ...
    hipLaunchKernelGGL(kernel_map_depth_to_other, mapping_blocks, threads, 0, 0, _d_pixel_map.get(), _d_depth_in.get(), _d_depth_intrinsics.get(), _d_other_intrinsics.get(),
        _d_depth_other_extrinsics.get(), depth_scale);

    switch (other_bytes_per_pixel)
    {
    case 1: hipLaunchKernelGGL(HIP_KERNEL_NAME(kernel_other_to_depth<1>), depth_blocks, threads, 0, 0, _d_aligned_out.get(), _d_other_in.get(), _d_pixel_map.get(), _d_depth_intrinsics.get(), _d_other_intrinsics.get()); break;
    case 2: hipLaunchKernelGGL(HIP_KERNEL_NAME(kernel_other_to_depth<2>), depth_blocks, threads, 0, 0, _d_aligned_out.get(), _d_other_in.get(), _d_pixel_map.get(), _d_depth_intrinsics.get(), _d_other_intrinsics.get()); break;
    case 3: hipLaunchKernelGGL(HIP_KERNEL_NAME(kernel_other_to_depth<3>), depth_blocks, threads, 0, 0, _d_aligned_out.get(), _d_other_in.get(), _d_pixel_map.get(), _d_depth_intrinsics.get(), _d_other_intrinsics.get()); break;
    case 4: hipLaunchKernelGGL(HIP_KERNEL_NAME(kernel_other_to_depth<4>), depth_blocks, threads, 0, 0, _d_aligned_out.get(), _d_other_in.get(), _d_pixel_map.get(), _d_depth_intrinsics.get(), _d_other_intrinsics.get()); break;
    }
...
void align_hip_helper::align_depth_to_other(unsigned char* h_aligned_out, const uint16_t* h_depth_in,
    float depth_scale, const rs2_intrinsics& h_depth_intrin, const rs2_extrinsics& h_depth_to_other,
    const rs2_intrinsics& h_other_intrin)
{
    ...
    hipLaunchKernelGGL(kernel_map_depth_to_other, mapping_blocks, threads, 0, 0, _d_pixel_map.get(), _d_depth_in.get(), _d_depth_intrinsics.get(),
        _d_other_intrinsics.get(), _d_depth_other_extrinsics.get(), depth_scale);

    hipLaunchKernelGGL(kernel_depth_to_other, depth_blocks, threads, 0, 0, (uint16_t*)_d_aligned_out.get(), _d_depth_in.get(), _d_pixel_map.get(),
        _d_depth_intrinsics.get(), _d_other_intrinsics.get());

    hipLaunchKernelGGL(kernel_replace_to_zero, other_blocks, threads, 0, 0, (uint16_t*)_d_aligned_out.get(), _d_other_intrinsics.get());
